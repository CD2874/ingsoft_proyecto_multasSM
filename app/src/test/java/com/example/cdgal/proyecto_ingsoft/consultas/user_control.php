...
include_once 'connection.php';
	...
	class User {
		...
		public function does_user_exist($usuario,$password) {
			$query = "select a.id as miide, a.nombre as nomb, a.usuario as usua, a.password as pass, b.id, b.privilegio as tipouser from credenciales a inner join privilegios b on a.privilegios_id = b.id where a.usuario='$usuario' and a.password='$password';";
			...
			if(mysqli_num_rows($result)>0){
				...
				$json['unosolo_user'] = $fila['miide'];
				//$json['unosolo_user'] = $fila['unosolo2'];
