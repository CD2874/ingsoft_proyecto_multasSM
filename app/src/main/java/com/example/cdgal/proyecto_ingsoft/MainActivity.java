...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentManager.beginTransaction().replace(R.id.contenedor, new VehiculosFragment()).commit();
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_vehiculos) {
            ...
            fragmentManager.beginTransaction().replace(R.id.contenedor, new Top10Fragment()).commit();
        } else if (id == R.id.nav_info) {
            fragmentManager.beginTransaction().replace(R.id.contenedor, new InfoFragment()).commit();
        } else if (id == R.id.nav_listados) {
            fragmentManager.beginTransaction().replace(R.id.contenedor, new ListadosFragment()).commit();
