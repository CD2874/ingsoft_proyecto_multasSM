...
public class ExpLVAdapter2 extends BaseExpandableListAdapter {

    private ArrayList<String> listDescripciones;
    private Map<String, ArrayList<String>> mapChil;
    private Context context;

    public ExpLVAdapter2(Context context, ArrayList<String> listDescripciones, Map<String, ArrayList<String>> mapChil) {
